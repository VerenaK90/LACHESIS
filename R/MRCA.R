...
MRCA <- function(normObj = NULL, min.seg.size = 10^7, fp.mean = 0, fp.sd = 0, excl.chr = NULL) {
    ...
    workObj$p_total_to_mrca <- apply(workObj[, c("n_mut_total_clonal", "Seglength")], 1, function(x) {
