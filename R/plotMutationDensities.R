...
.getCentromeres <- function(build = "hg19") {
    if (build == "hg19") {
        centromeres <- c(
            123400000, 93900000, 91000000, 50000000, 48800000, 60000000, 58000000,
        ...
        centromeres <- c(
            121000000, 93300000, 91000000, 50000000, 48800000, 60000000, 58000000,
            45000000, 50000000, 39500000, 53000000, 35500000, 17500000, 18000000,
            36500000, 36000000, 38000000, 18500000, 27500000, 29000000, 14000000,
            12000000, 61000000, 17500000
        )
        ...
        centromeres <- c(
            123400000, 93300000, 91000000, 50000000, 48800000, 60000000, 58000000,
            45000000, 50000000, 39500000, 53000000, 35500000, 17500000, 18000000,
            36500000, 36000000, 38000000, 18500000, 27500000, 29000000, 14000000,
            12000000, 61000000, 17500000
        )
