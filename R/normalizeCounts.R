...
normalizeCounts <- function(countObj = NULL) {
    ...
    normObj[, n_mut_total_clonal := (A * n_mut_A + B * n_mut_B + n_mut_total_clonal -
        n_mut_A - n_mut_B) / (A + B)]
    ...
    normObj[, density_total_lower := 0.5 * qchisq(0.025, n_mut_total_clonal * 2) /
        Seglength * 10^6]
    normObj[, density_total_upper := 0.5 * qchisq(0.975, n_mut_total_clonal * 2 + 2) /
        Seglength * 10^6]
