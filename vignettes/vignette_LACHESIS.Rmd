...
# do we need this? seems like there are no other packages with similar names?
...
## I think we should use this example here: #' lachesis <- LACHESIS(ids = "NBE11", cnv.files = aceseq_cn, snv.files = strelka_vcf, vcf.source = "strelka", purity = 0.83, ploidy = 2.59) - what you currently use as an example actually generates an input file and doesn't use vectors
