...
There are two ways to perform analyses using LACHESIS: either by utilizing the sub-functions individually or by calling the wrapper function. All of the functions presented in the main workflow are also invoked within the wrapper function. In addition, the generated data is merged, allowing both cohort analysis and survival analysis to be performed.
